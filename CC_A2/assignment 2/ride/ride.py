...
def create_ride():
    ...
    r = res.get("http://user:8080/api/v1/users")
    print(r)
    ...
    s=res.post("http://localhost:8000/api/v1/db/write",json=new_ride_json)
    return { },201
...
def get_all_rides():
    ...
    rides=res.post("http://localhost:8000/api/v1/db/read",json=get_ride)
    return rides
...
def join_ride(rideId):
    ...
    rides=res.post("http://localhost:8000/api/v1/db/write",json=append_user)
    return rides
...
def delete_ride(rideId):
    ...
    s=res.post("http://localhost:8000/api/v1/db/write",json=delete_ride)
    return {},200
...
def clear_db():
    ...
    s=res.post("http://localhost:8000/api/v1/db/write",json=new_user)
    return s
